...
pub fn lesson_title(lesson: &Lesson, language: Language) -> &'static str {
    ...
    match lesson.id {
        ...
        "generics-traits" => "Read trait bounds and lifetimes from ripgrep generics",
...
pub fn lesson_summary(lesson: &Lesson, language: Language) -> &'static str {
    ...
    match lesson.id {
        ...
        "generics-traits" => "Use globset Candidate and searcher SinkError to make AsRef, Display, Debug, and lifetimes concrete.",
...
pub fn lesson_goal(lesson: &Lesson, index: usize, language: Language) -> &'static str {
    ...
    match (lesson.id, index) {
        ...
        ("generics-traits", 0) => "Read AsRef<Path> in path-like APIs",
        ("generics-traits", 1) => "Connect Display and Debug bounds to real formatting needs",
        ("generics-traits", 2) => "Explain lifetimes in borrowed data structures",
...
pub fn exercise_title(exercise: &Exercise, language: Language) -> &'static str {
    ...
    match exercise.id {
        ...
        "generic-largest" => "Candidate::new needs a path-like bound",
        ...
        "impl-trait-param" => "Display bound for error messages",
...
pub fn exercise_prompt(exercise: &Exercise, language: Language) -> &'static str {
    ...
    match exercise.id {
        ...
        "generic-largest" => "In ripgrep's Candidate::new, which capability lets P be borrowed as a Path?",
        ...
        "impl-trait-param" => "When ripgrep turns an error message into text, what trait bound should T have?",
...
pub fn exercise_explanation(exercise: &Exercise, language: Language) -> &'static str {
    ...
    match exercise.id {
        ...
        "generic-largest" => "`AsRef<Path>` lets ripgrep accept path-like inputs and call `path.as_ref()` before building a Candidate.",
        ...
        "impl-trait-param" => "`Display` provides user-facing formatting; ripgrep can then call `to_string()` to turn the generic message into error text.",
...
pub fn exercise_hint(exercise: &Exercise, language: Language) -> &'static str {
    ...
    match exercise.id {
        ...
        "generic-largest" => "Look at the method body: it calls `path.as_ref()`.",
        ...
        "impl-trait-param" => "`to_string()` and `{}` formatting point to Display.",
