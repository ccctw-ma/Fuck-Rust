...
pub fn t(language: Language, key: &str) -> &'static str {
    match language {
        Language::Zh => match key {
            ...
            "quick_guide" => "先学这个",
            "learning_goals" => "掌握目标",
            "primer_title" => "答题前先建立知识框架",
            "concept_model" => "核心概念模型",
            "syntax_anchor" => "看题时抓这些位置",
            "before_answer" => "下笔前检查",
            "cards_title" => "知识卡片",
        ...
        Language::En => match key {
            ...
            "primer_title" => "Build the mental model first",
            "concept_model" => "Core model",
            "syntax_anchor" => "What to inspect",
            "before_answer" => "Before answering",
